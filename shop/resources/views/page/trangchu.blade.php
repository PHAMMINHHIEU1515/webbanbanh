...
<div class="row">
    <div class="col-sm-12">
        <div class="beta-products-list">
            <h4 style="color: red; font-weight: bold" >Sản phẩm mới</h4>
            <div class="beta-products-details">
                <p class="pull-left">Tìm thấy <span style="color: blue;font-weight: bold">{{count($new_product)}}</span> sản phẩm</p>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="single-item">
                        ...
                        <div class="single-item-body" style="color: red;font-weight: bold">
        ...
        <div class="beta-products-list">
            <h4 style="color: red; font-weight: bold">Sản phẩm khuyến mãi</h4>
            <div class="beta-products-details">
                <p class="pull-left">Tìm thấy <span style="color: blue;font-weight: bold"> {{count($sanpham_khuyenmai)}}</span> sản phẩm</p>
                <div class="clearfix"></div>
            </div>
            <div class="row">
