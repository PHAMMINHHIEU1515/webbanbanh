								...
								<ul class="payment_methods methods">
									...
									<li class="payment_method_cheque">
										...
										<div class="payment_box payment_method_cheque" style="display: none; margin: 10px">
											...
											<p style="font-size: 20px"> số tài khoản: <span style="color: rgb(136, 136, 231)"><b>4444444444444</b></span></p>
											<p style="font-size: 20px"> Chủ tài khoản:s <span style="color: rgb(238, 9, 9)"><b>Phạm Minh Hiếu</b></span> </p>
										</div>						
									</li>
